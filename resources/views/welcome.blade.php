                ...
                <div class="container">
                    <div class="c_form">
                        <form action="">
                            ...
                            <div class="row">
                                <div style="text-align: left; padding-left: 45px;" class="col-md-6">
                                    <!-- <label for="fname">First Name</label> -->
                                ...
                                <div style="text-align: right; padding-right: 45px; padding-top: 10px;" class="col-md-6">
                                    <!-- <label for="fname">First Name</label> -->
